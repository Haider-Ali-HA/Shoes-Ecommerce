  ...
  return (
    <div className="flex flex-col justify-center w-full my-28">
      <form className="flex flex-col items-center justify-center   gap-4" action="https://formspree.io/f/mrbzgkoq" method="post">
        ...
        <textarea className="text-sm sm:text-base border w-72 sm:w-96 outline-none p-3 h-32 sm:h-36 rounded-lg" name="Description" required autoComplete="off" placeholder="Enter your message"></textarea>
